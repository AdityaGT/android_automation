...
*** Keywords ***
start
     Open Application    http://localhost:4723/wd/hub	platformName=${platform}	platformVersion=${android_version}	deviceName=${phone_ip}    appPackage=${demoapp_package}    appActivity=${demoapp_main_activity}    automationName=UiAutomator2
